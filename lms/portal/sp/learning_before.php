                ...
                ?>
                    <?php  
                       foreach ( $category_tree as $key=>$category2 ) {//子类 循环  ； 
                                ...
                                $url2 = "course_catalog.php?category_id=" . $category2 ['id']."&select=1";
                                                      ...
                                                      <p class="dtit"><b><a class="sun" style="color:#868D86" href="<?=$url2?>" > <?=$cate_name2?></a></b></p>
                                                          ...
                                                          if($select_counts>0){
                                                              ...
                                                              if($select_counts == $count_users){
                                                                  ...
                                                                  echo '<span class="learn_center"><a  href="'.$url2.'">继续选课</a></span><span class="look_course"><a  href="'.$url2_learning.'">进入学习</a></span>';
                                                              }
                                                          }else{
