...
//platform为3时，在‘系统设置’中有‘在线考试’页
/**
$plats=file_get_contents(URL_ROOT.'/www'.URL_APPEDND.'/storage/DATA/platform.conf');
$plat_array=explode(':',$plats);
$plat=intval(trim($plat_array[1]));
if($plat=='3'){   
$resultcategories = array ('Company', 'MailServer', 'Security', 'Platform', 'Exam'  );
 }else{    
$resultcategories = array ('Company', 'MailServer', 'Security', 'Platform');
 } 
**/
