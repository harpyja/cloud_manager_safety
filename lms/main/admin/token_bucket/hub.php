...
$to =  api_sql_query ("CREATE TABLE if not exists `vslab`.`hub` (\n"
    ...
    . " PRIMARY KEY ( `pid` )\n"
    . ") ENGINE = MEMORY auto_increment=1 charset=utf8;");
...
if($hub_type=="porthub"){
    $porthub_data = array (
        'userid' => intval(getgpc('userid','G')),
        'lessionid' =>intval(getgpc('lessionid','G')),
    ...
    $porthub_data = array (
        'userid' => intval(getgpc('userid')),
        'lessionid' =>intval(getgpc('lessionid')),
