    ...
    <div class="framePage stud">
        <div id="Resources">
            <div id="treeview"><iframe id="CategoryTree" name="CategoryTree"
                                       src="vmmanage_tree.php" frameborder="0" width="100%" style="min-height:440px"></iframe></div>
            <div id="frm"><iframe id="List" name="List"
                                  src="vmmanage_list.php" frameborder="0" width="100%" style="min-height:440px"></iframe></div>
        </div>
    </div>
</center>
