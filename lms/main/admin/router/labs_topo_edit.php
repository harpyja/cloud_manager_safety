...
if(isset($id)){
    $sql="select * from $table_labs where id = '".$id."'";
...
$form->addElement ( 'textarea', 'info', "信息", array (  'id' => 'info','class' => 'inputText','type'=>'textarea','style' => 'width:80%;height:150px') );
$form->addElement ( 'textarea', 'netmap', "netmap", array (  'style' => "width:80%;height:100px", 'class' => 'inputText' ) );
...
if ($form->validate ()) {
    ...
    $devices_sql="UPDATE  `vslab`.`labs_devices` SET  `lab_id` =  '".$name."' WHERE  `labs_devices`.`lab_id` ='".$labsName."'";
