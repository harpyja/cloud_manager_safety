...
<section id="main" class="column">
    <h4 class="page-mark">当前位置：<a href="<?=URL_APPEDND;?>/main/admin/index.php">平台首页</a> &gt; <a href="<?=uRL_APPEDND;?>/main/admin/user/user_list_iframe.php">用户管理</a> &gt;组织架构管理</h4>
    <div class="managerSearch">
        <span class="searchtxt right"><?php echo link_button ( 'add_dept.gif', 'OrgAdd', 'org_update.php?action=add&pid=' . DEPT_TOP_ID, '50%', '70%' );?></span>
    </div>
